...
/** Free symmetric monoidal scan description (standalone ADT; swap for `FreeA` later). */
...
object FreeScan:
  ...
  case class AndThen[I, M, O](l: FreeScan[I, M], r: FreeScan[M, O]) extends FreeScan[I, O]

  case class Fanout[I, OL, OR](l: FreeScan[I, OL], r: FreeScan[I, OR]) extends FreeScan[I, (OL, OR)]

  case class Choice[IL, IR, O](l: FreeScan[IL, O], r: FreeScan[IR, O]) extends FreeScan[Either[IL, IR], O]
